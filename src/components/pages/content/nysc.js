...
function NYSC() {
  return (
    <div>
        {/* Add NYSC Work  */}
        <div class="modal fade px-5" id="nyscWork">
            <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">NYSC WORK</h4>
                </div>
            ...
            {/* VIEW NYSC WORK */}            
            <div class="modal fade" id="viewNyscWork">
                <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title mx-4">NYSC WORKS</h4>
                    </div>
                    <div class="modal-body">
                        <form class="mx-3">
                            <div class="container">
            ...
            {/* Edit NYSC WORK Starts */}
            <div class="modal fade px-5" id="editNyscWork">
                <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">EDIT : NYSC WORK</h4>
                    </div>
                    <div class="modal-body">
                        <form>
                            <div class="container">
